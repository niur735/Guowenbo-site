...
$('.cove8').mouseenter(function(){
    $('.title8').css('color','#CDDBE2');
});

$('.cover8').mouseleave(function(){
    $('.title8').css('color','black');
});
var a = 1;
var b = 1;
var c = 1;
...
$('.cover8').click(function(){
if(h==1)
    {$('.detail8').css('display','block');
    $('.imgh').css('left','15vw');
    $('.cover8').css('left','15vw');
    h=0;}
else{
    $('.detail8').css('display','none');
    $('.imgh').css('left','35vw');
    $('.cover8').css('left','35vw');
    h=1;}
});